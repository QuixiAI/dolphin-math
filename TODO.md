...
- [ ] Simplify radicals with variables — √(50x³) → 5x√(2x) · `RadicalVariableSimplifyGenerator` · high · d4
...
- [ ] Solve radical equations — MUST check for extraneous roots (A1) · `RadicalEquationGenerator` · high · d5
...
- [ ] Polar ↔ rectangular (points & equations); parametric → rectangular · `PolarParametricGenerator` · high · d5

### Vectors & Matrices
- [ ] Vector add/subtract, scalar multiply, magnitude, unit vector · `VectorOpsGenerator` · high · d4
- [ ] Dot product; angle between vectors · `DotProductGenerator` · high · d4
...
### Probability
- [ ] Permutations & combinations — factorial arithmetic shown step by step (**was falsely checked off — no generator exists**) · `PermutationCombinationGenerator` · middle · d4
