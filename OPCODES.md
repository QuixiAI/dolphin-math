...
| `IDENTITY` | 2 | `IDENTITY\|sin(5x)*cos(32x)\|1/2(sin(37x) + sin(27x))` | function_inner_product_generator.py |
...
| `MATRIX_PRODUCT` | 2 | `MATRIX_PRODUCT\|AB\|[[0, i/2], [i/2, 0]]` | casimir_generator.py, pauli_algebra_generator.py, structure_constant_generator.py |
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|row 1\|0, 1, 0, 1` | graph_counting_generator.py |
| `MATRIX_SCALE` | 2 | `MATRIX_SCALE\|1/2 ladder sum\|[[1600/121, 0, 0], [0, 3200/121, 0], [0, 0, 1600/121]]` | casimir_generator.py |
