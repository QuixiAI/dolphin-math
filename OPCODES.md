...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|1x^3 + 1x^2 + 5x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|67154 × 13667 ≈ 70000 × 10000\|700000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|700000000\|917793718\|917793718 ≈ 700000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|28 - 12 = 16, not 8` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-7x) * (-7x)\|49x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (1) * (-7x)\|-7x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (1) * (-6)\|-6` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-7x) * (-6)\|42x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(-7x + 1)(-7x - 6)` | multiplying_binomials_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 5:11\|line 4 multiplies 5 by 4` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(31, 7)\|P(X > 38)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(10x^5 - 5x^3 - 15x^3) / (-5x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(10x^5) / (-5x^3) + (-5x^3) / (-5x^3) + (-15x^3) / (-5x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 1)(x^2 + x + 5)` | multiplying_polynomials_generator.py |
...
| `ROOT` | 2 | `ROOT\|5625\|75` | completing_square_generator.py, factor_special_forms_generator.py, pythag_hyp_generator.py, quadratic_generator.py, quadratic_square_root_generator.py, round_solids_generator.py |
| `ROOT_EXTRACT` | 2 | `ROOT_EXTRACT\|7\|√7` | exponent_generator.py |
| `ROOT_IDENTIFY` | 3 | `ROOT_IDENTIFY\|343\|49\|7` | exponent_generator.py |
| `ROOT_SETUP` | 1 | `ROOT_SETUP\|√343` | exponent_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|Φ(1.00)\|0.8413` | normal_table_generator.py |
