...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|5x + 3 = 10` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|4x - 8 >= 12 -> x >= 5` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|4x - 8\| >= 12` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <=` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|4x - 8 >= 12 OR 4x - 8 <= -12` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|5x + 3\| = 10` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|5x + 3 = 10\|5x + 3 = -10` | absolute_value_equation_generator.py |
...
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|supplementary\|angle1 = 136°` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|180 - 136\|44` | angle_relationships_generator.py |
...
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|C = 4π\|4π` | circle_generator.py |
| `CIRCLE_FORMULA` | 1 | `CIRCLE_FORMULA\|C = 2πr` | circle_generator.py |
| `CIRCLE_SETUP` | 2 | `CIRCLE_SETUP\|2\|radius` | circle_generator.py |
| `CIRCLE_SUBSTITUTE` | 1 | `CIRCLE_SUBSTITUTE\|C = 2 × π × 2` | circle_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|2x - 2 < -4 -> x < -1` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|2x - 2 < -4 OR 2x - 2 > 13` | compound_inequality_generator.py |
...
| `DISC` | 3 | `DISC\|81\|72\|9` | quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|20y + -92 = 8` | systems_substitution_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|6x^3 - 9x^2 + 6x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|5\|2\|25` | pythag_hyp_generator.py, round_solids_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-10, -3)\|(-8, 1)` | equation_from_two_points_generator.py |
...
| `EXP_RULE_APPLY` | 4 | `EXP_RULE_APPLY\|multiply\|2\|3\|6` | exponent_generator.py, exponent_mixed_rules_generator.py |
| `EXP_RULE_IDENTIFY` | 2 | `EXP_RULE_IDENTIFY\|zero_exponent\|x^0 = 1 (for x ≠ 0)` | exponent_generator.py, exponent_mixed_rules_generator.py |
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|m^0` | exponent_generator.py, exponent_mixed_rules_generator.py |
...
| `FOIL_F` | 2 | `FOIL_F\|First: (-8x) * (7x)\|-56x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (9) * (7x)\|63x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (9) * (-6)\|-54` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-8x) * (-6)\|48x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(-8x + 9)(7x - 6)` | multiplying_binomials_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|5\|-16 <= 3x <= 6` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = -3x - 8\|(-9, -10)` | parallel_perpendicular_line_generator.py |
...
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|8 / 2\|4` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|8 * -7\|-56` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(8x^6)(-7x^4)` | monomial_mult_div_generator.py |
| `MONO_SUB_EXP` | 2 | `MONO_SUB_EXP\|x^5 / x^1 = x^(5-1)\|x^4` | monomial_mult_div_generator.py |
...
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|5x + 34 = 6x + 24` | angle_relationships_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.8\|60\|48` | percent_problem_generator.py |
...
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 3 = 2(x + 10)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-5x + 5` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(40x^6 - 8x^4 - 8x^2 + 16x^2) / (8x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(40x^6) / (8x^2) + (-8x^4) / (8x^2) + (-8x^2) / (8x^2) + (16x^2) / (8x^2)` | polynomial_div_monomial_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-8x +3x) + (-4 +9)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x - 1)(-2x^2 + 3x - 2)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1 | `POLY_SETUP\|(-8x - 4) - (-3x - 9)` | polynomial_add_sub_generator.py |
...
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Two dice rolls, looking for 5 then 6` | compound_probability_generator.py |
| `PROB_IDENTIFY` | 2 | `PROB_IDENTIFY\|P(rolling 5)\|1/6` | compound_probability_generator.py |
...
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|81\|9` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 3 | `PYTHAG_SETUP\|c=15\|a=12\|b=?` | pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 225 - 144\|81` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|12\|144` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|12² + b² = 15²` | pythag_leg_generator.py |
| `Q1` | 4 | `Q1\|9\|3\|6\|2` | quadratic_generator.py |
| `Q2` | 4 | `Q2\|9\|3\|6\|1` | quadratic_generator.py |
...
| `REWRITE` | 1 | `REWRITE\|12 + 36` | evaluate_expression_generator.py, exponent_mixed_rules_generator.py, linear_complex_generator.py, linear_fractional_generator.py, literal_equation_generator.py, order_of_operations_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
| `ROOT` | 2 | `ROOT\|289\|17` | pythag_hyp_generator.py, quadratic_generator.py, round_solids_generator.py |
| `ROOT_EXTRACT` | 2 | `ROOT_EXTRACT\|9` | exponent_generator.py |
| `ROOT_IDENTIFY` | 3 | `ROOT_IDENTIFY\|729\|perfect_cube\|9` | exponent_generator.py |
| `ROOT_SETUP` | 1 | `ROOT_SETUP\|∛729` | exponent_generator.py |
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|5√11` | exponent_generator.py |
...
| `SA_BASES` | 2 | `SA_BASES\|2π(4)² = 2π × 16\|32π` | volume_3d_generator.py |
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|10 × 11\|110` | volume_3d_generator.py |
| `SA_FORMULA` | 1 | `SA_FORMULA\|SA = 2(lw + lh + wh)` | round_solids_generator.py, volume_3d_generator.py |
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 4 × 7\|56π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=10, w=11, h=7` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(110 + 70 + 77)\|514` | round_solids_generator.py, volume_3d_generator.py |
...
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|5.7\|8` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|left\|8` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|multiply_coefficients\|1.1\|3.5\|3.8500000000000005` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|(1.1 × 10^6) × (3.5 × 10^6)` | exponent_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.8 * 60` | percent_problem_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -6 + 8x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|2` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-3, -7)\|(-4, -4)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-4 - (-7)) / (-4 - (-3))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(41 + 46) / 2\|43.5` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|7` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|26\|33\|-7` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|259 / 7\|37` | statistics_generator.py |
| `STAT_FREQUENCY` | 2 | `STAT_FREQUENCY\|16\|1` | statistics_generator.py |
| `STAT_MAD` | 3 | `STAT_MAD\|64\|7\|9.14` | statistics_generator.py |
| `STAT_MAX` | 1 | `STAT_MAX\|84` | statistics_generator.py |
| `STAT_MEAN` | 2 | `STAT_MEAN\|231 / 7\|33` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|position 4\|60` | statistics_generator.py |
| `STAT_MIN` | 1 | `STAT_MIN\|14` | statistics_generator.py |
| `STAT_MODE` | 2 | `STAT_MODE\|31 and 62\|3` | statistics_generator.py |
| `STAT_ORDER` | 1 | `STAT_ORDER\|32, 33, 56, 60, 63, 82, 98` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|84 - 14\|70` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|55, 41, 17, 35, 40, 35, 36` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|55 + 41 + 17 + 35 + 40 + 35 + 36\|259` | statistics_generator.py |
...
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -3y = -18` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with y only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -4y + 23` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * -1` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|5x - 1y = -6\|-5x - 2y = -12` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x + 4y = 23\|-4x + 4y = 8` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=5 into x = -4y + 23` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|4x + 10\|4x + 2\|4x - 12` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|12x + 0 = 180\|x = 15` | angle_relationships_generator.py |
| `TRI_ANGLE_SUM` | 1 | `TRI_ANGLE_SUM\|(4x + 10) + (4x + 2) + (4x - 12) = 180` | angle_relationships_generator.py |
