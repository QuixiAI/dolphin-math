...
339 distinct op-codes observed.
...
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(x + 2)^2 = -16(y + 1)\|vertex, focus, directrix` | parabola_features_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|- 12x^3 + 15x^2 - 12x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|39304 × 21799 ≈ 40000 × 20000\|800000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|800000000\|856787896\|856787896 ≈ 800000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | complex_division_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, log_conversion_generator.py, log_properties_generator.py, parabola_features_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-6 ÷ 3 = -2, not -3` | error_spotting_generator.py |
| `FOCUS` | 1 | `FOCUS\|(-2, -5)` | parabola_features_generator.py |
...
| `FORM_IDENTIFY` | 2 | `FORM_IDENTIFY\|difference_of_squares\|a^2 - b^2 = (a - b)(a + b)` | completing_square_generator.py, factor_special_forms_generator.py, parabola_features_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_equation_generator.py, rational_exponent_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 9:11\|line 4 multiplies 9 by 7` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(70, 11)\|P(77.7 < X < 83.2)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(6x^6 + 6x^6 + 6x^5 - 30x^4) / (6x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(6x^6) / (6x^2) + (6x^6) / (6x^2) + (6x^5) / (6x^2) + (-30x^4) / (6x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x + 4)(4x^2 - 5x + 4)` | multiplying_polynomials_generator.py |
...
| `VERTEX` | 1 | `VERTEX\|(-2, -1)` | parabola_features_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(77.7 - 70)/11\|0.70` | normal_table_generator.py |
