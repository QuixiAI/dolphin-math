...
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|- 15x^3 - 3x^2 + 3x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|71894 × 31601 ≈ 70000 × 30000\|2100000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2100000000\|2271922294\|2271922294 ≈ 2100000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|9 × 12 = 108, not 96` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 18% to 0.18\|line 3 adds the tip 11.52 to the bill` | fill_in_step_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 2x^6 + 6x^6 - 2x^2 - 2x^2) / (-2x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-2x^6) / (-2x^2) + (6x^6) / (-2x^2) + (-2x^2) / (-2x^2) + (-2x^2) / (-2x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x - 3)(5x^2 + x - 1)` | multiplying_polynomials_generator.py |
