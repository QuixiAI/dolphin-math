...
272 distinct op-codes observed.
...
| `CBRT` | 2 | `CBRT\|8y^3\|2y` | factor_special_forms_generator.py |
| `CHECK` | 3 | `CHECK\|multiply_back\|23×98+45=2299\|2299` | error_spotting_generator.py, factor_gcf_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, long_division_generator.py, ratio_table_generator.py, special_solution_equation_generator.py, systems_elimination_generator.py, tip_bill_split_generator.py, two_step_equation_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|1x^3 + 4x^2 + 3x` | multiplying_polynomials_generator.py |
...
| `EQ_OP_BOTH` | 4 | `EQ_OP_BOTH\|divide\|4\|x\|-8` | absolute_value_equation_generator.py, error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, one_step_equation_generator.py, special_solution_equation_generator.py, systems_elimination_generator.py, systems_substitution_generator.py, two_step_equation_generator.py |
...
| `EQ_RESULT` | 2 | `EQ_RESULT\|x\|-8` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, one_step_equation_generator.py, special_solution_equation_generator.py, two_step_equation_generator.py |
| `EQ_SETUP` | 1 | `EQ_SETUP\|x = 45/3` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, literal_equation_generator.py, one_step_equation_generator.py, proportion_word_problem_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py, two_step_equation_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|85471 × 63773 ≈ 90000 × 60000\|5400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5400000000\|5450742083\|5450742083 ≈ 5400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FACTOR_GROUP` | 3 | `FACTOR_GROUP\|9x^2 + 15x\|3x\|(3x + 5)` | factor_trinomial_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|33 ÷ 11 = 3, not 1` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-2x) * (3x)\|-6x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (9) * (3x)\|27x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (9) * (3)\|27` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-2x) * (3)\|-6x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(-2x + 9)(3x + 3)` | multiplying_binomials_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|36, 12, 30\|6` | factor_gcf_generator.py |
| `GCF_RESULT` | 1 | `GCF_RESULT\|6` | factor_gcf_generator.py |
| `GCF_VAR` | 2 | `GCF_VAR\|n^5, n^3, n\|n` | factor_gcf_generator.py |
...
| `GROUP` | 2 | `GROUP\|(9x^2 + 15x)\|(3x + 5)` | factor_trinomial_generator.py |
...
| `MOVE_TERM` | 3 | `MOVE_TERM\|+4x\|left\|-4x+9-4x = +4` | linear_complex_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 9:8\|line 4 multiplies 9 by 7` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(510, 11)\|P(X < 515.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 4x^4 - 20x^2) / (4x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-4x^4) / (4x) + (-20x^2) / (4x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 1)(x^2 + 4x + 3)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1 | `POLY_SETUP\|(4x^3 - x + 9) + (8x^2 - 7x - 5)` | factor_gcf_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py |
...
| `REWRITE` | 1 | `REWRITE\|8 + 90` | evaluate_expression_generator.py, exponent_mixed_rules_generator.py, factor_gcf_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, linear_complex_generator.py, linear_fractional_generator.py, literal_equation_generator.py, normal_table_generator.py, order_of_operations_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|Φ(0.50)\|0.6915` | normal_table_generator.py |
