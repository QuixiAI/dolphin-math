...
| `DIST_TERM` | 2 | `DIST_TERM\|4x\|4x^3 - 8x^2 + 16x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|79000 × 41632 ≈ 80000 × 40000\|3200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3200000000\|3288928000\|3288928000 ≈ 3200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | circle_equation_generator.py, complex_division_generator.py, conic_standard_form_generator.py, ellipse_features_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, hyperbola_features_generator.py, log_conversion_generator.py, log_properties_generator.py, parabola_features_generator.py, polar_parametric_generator.py, recursive_explicit_generator.py, regular_polygon_area_generator.py, remainder_factor_theorem_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, vector_ops_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|22 + 14 = 36, not 18` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 3x = 18\|line 5 shows x = 6` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(38, 8)\|P(X > 53.2)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 1x - 2x) / (-x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-1x) / (-x) + (-2x) / (-x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(4x + 5)(x^2 - 2x + 4)` | multiplying_polynomials_generator.py |
...
| `RATIONALIZE` | 1 | `RATIONALIZE\|(3 - √6)/(3 - √6)` | radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|7√7` | complex_quadratic_generator.py, distance_formula_generator.py, exponent_generator.py, geometric_mean_generator.py, hypercube_counting_generator.py, polar_parametric_generator.py, vector_ops_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(5)\|18` | function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
...
| `VEC_SETUP` | 2 | `VEC_SETUP\|v = ⟨12, -16⟩\|unit vector` | vector_ops_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(53.2 - 38)/8\|1.90` | normal_table_generator.py |
