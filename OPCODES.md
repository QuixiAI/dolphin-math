...
922 distinct op-codes observed.
...
| `TRIG_VALUE` | 2, 3 | `TRIG_VALUE\|sin(lat1)=1\|sin(lat2)=0\|cos(dlon)=-1/2` | great_circle_generator.py, spherical_triangle_generator.py |
