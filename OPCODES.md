...
920 distinct op-codes observed.
...
| `DOT` | 2, 3 | `DOT\|(15, 33) · (0, 1)\|15*0 + 33*1\|33` | gradient_generator.py, gram_schmidt_generator.py, line_integral_generator.py |
...
| `PARTIAL` | 2 | `PARTIAL\|u_x\|4x + 2` | cauchy_riemann_generator.py |
...
| `ROOT` | 1, 2, 3 | `ROOT\|2601\|51` | completing_square_generator.py, confidence_interval_generator.py, de_moivre_generator.py, factor_special_forms_generator.py, hypothesis_test_generator.py, pythag_hyp_generator.py, quadratic_generator.py, quadratic_square_root_generator.py, radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py, rational_equation_generator.py, rational_exponent_generator.py, regression_generator.py, round_solids_generator.py, svd_generator.py |
