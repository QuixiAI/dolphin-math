...
1071 distinct op-codes observed.
...
| `COUNT` | 2 | `COUNT\|A = [4, 5, 6]\|3/6` | probability_addition_rule_generator.py, set_operations_generator.py |
...
| `DERIVATIVE` | 1, 2 | `DERIVATIVE\|g'(x)\|5/8` | fixed_point_generator.py, mgf_generator.py |
