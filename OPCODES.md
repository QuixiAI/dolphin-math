...
| `CANCEL` | 2 | `CANCEL\|5y\|7y - 5` | derivative_limit_def_generator.py, limit_evaluation_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, rational_function_features_generator.py |
...
| `DERIV_RULE` | 2 | `DERIV_RULE\|power rule\|d/dx of c·x^n = c·n·x^(n-1)` | derivative_power_rule_generator.py, derivative_product_quotient_generator.py |
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 3x^4 - 6x^2 + x\|f'(x)` | derivative_power_rule_generator.py, derivative_product_quotient_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|5x\|- 10x^3 - 25x^2 - 5x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|24182 × 24091 ≈ 20000 × 20000\|400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|400000000\|582568562\|582568562 ≈ 400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|41 - 13 = 28, not 36` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 20.50\|line 4 answers $225.50` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(47, 7)\|P(X < 52.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 2x^5 - 1x^5 + 5x^5 - 4x^2) / (x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-2x^5) / (x^2) + (-1x^5) / (x^2) + (5x^5) / (x^2) + (-4x^2) / (x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(5x + 1)(-2x^2 - 5x - 1)` | multiplying_polynomials_generator.py |
...
| `POWER_RULE` | 2 | `POWER_RULE\|3x^4\|12x^3` | derivative_power_rule_generator.py, derivative_product_quotient_generator.py |
...
| `SUBST` | 3 | `SUBST\|x\|-5\|2(-5)+5y+7` | derivative_limit_def_generator.py, evaluate_expression_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, limit_evaluation_generator.py, piecewise_evaluation_generator.py, polar_parametric_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, trig_equation_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(52.6 - 47)/7\|0.80` | normal_table_generator.py |
