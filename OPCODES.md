...
416 distinct op-codes observed.
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|16x^3\|4x^4` | antiderivative_generator.py, area_between_curves_generator.py, definite_integral_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-5x\|- 5x^3 + 10x^2 + 25x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|99056 × 13405 ≈ 100000 × 10000\|1000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1000000000\|1327845680\|1327845680 ≈ 1000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|48 ÷ 8 = 6, not 4` | error_spotting_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (16x^3 - 9x^2 - 4x) dx\|antiderivative` | antiderivative_generator.py, definite_integral_generator.py, u_substitution_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 24:44\|line 3 divides 66 by 11` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(89, 15)\|P(X > 95)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(36x^6 - 9x^6) / (-9x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(36x^6) / (-9x^3) + (-9x^6) / (-9x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-5x + 1)(x^2 - 2x - 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(95 - 89)/15\|0.40` | normal_table_generator.py |
