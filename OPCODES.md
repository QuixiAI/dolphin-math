...
| `ALPHA` | 2 | `ALPHA\|alpha1\|-95/48` | kernel_ridge_generator.py |
...
| `ATTN_OUTPUT` | 2 | `ATTN_OUTPUT\|1\|[[2/3,-5/3]]` | attention_generator.py |
...
| `KP_SETUP` | 3 | `KP_SETUP\|kernel=linear\|data=[(-6,-1), (5,1), (3,-1)]\|alpha0=(0,0,0)` | kernel_perceptron_generator.py |
...
| `KRR_SETUP` | 3 | `KRR_SETUP\|kernel=linear\|data=[(-3,-5), (6,-5)]\|lambda=3,x*=-5` | kernel_ridge_generator.py |
...
| `PREDICT` | 2 | `PREDICT\|x*\|25/16` | kernel_ridge_generator.py |
...
| `RIDGE_ENTRY` | 2 | `RIDGE_ENTRY\|K\|[[9,-18], [-18,36]]` | kernel_ridge_generator.py |
...
| `SOFTMAX_EXP` | 2 | `SOFTMAX_EXP\|1,1\|1` | attention_generator.py |
...
| `SVM_SETUP` | 3 | `SVM_SETUP\|x1=(8,0),y1=1,alpha1=1\|x2=(0,15),y2=1,alpha2=1\|b=0,x=(0,0)` | svm_margin_generator.py |
...
| `UPDATE` | 2 | `UPDATE\|W1_11\|-19/7` | backprop_generator.py, kernel_perceptron_generator.py |
