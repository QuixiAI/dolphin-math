...
| `DIST_TERM` | 2 | `DIST_TERM\|4x\|- 16x^3 - 4x^2 + 12x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|42702 × 36049 ≈ 40000 × 40000\|1600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1600000000\|1539364398\|1539364398 ≈ 1600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|63 ÷ 9 = 7, not 5` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (7x) * (5x)\|35x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (9) * (5x)\|45x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (9) * (5)\|45` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (7x) * (5)\|35x` | multiplying_binomials_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 2x - 3 = -21\|line 3 shows 2x = -18` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(493, 5)\|P(X < 501.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(2x^5 - 8x^4 + 10x^2) / (2x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(2x^5) / (2x) + (-8x^4) / (2x) + (10x^2) / (2x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(4x + 2)(-4x^2 - x + 3)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(501.5 - 493)/5\|1.70` | normal_table_generator.py |
