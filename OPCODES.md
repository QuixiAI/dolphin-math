...
| `DET` | 2 | `DET\|K\|-41` | kernel_validity_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(15, 33) · (0, 1)\|15*0 + 33*1\|33` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py |
...
| `FEATURE_MAP_SETUP` | 3 | `FEATURE_MAP_SETUP\|K(x,z)=(xz+2)^2\|phi(t)=(t^2,2t,2)\|x=-5,z=18` | feature_map_generator.py |
...
| `KERNEL_BASE` | 3 | `KERNEL_BASE\|A,A\|dot+c=18+0\|18` | feature_map_generator.py, kernel_evaluation_generator.py |
...
| `KERNEL_VALUE` | 2 | `KERNEL_VALUE\|A,A\|1` | feature_map_generator.py, kernel_evaluation_generator.py |
