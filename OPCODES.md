...
427 distinct op-codes observed.
...
| `CANCEL` | 2 | `CANCEL\|5y\|7y - 5` | derivative_limit_def_generator.py, derivative_transcendental_generator.py, limit_evaluation_generator.py, power_series_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, rational_function_features_generator.py, series_convergence_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|12987 × 4298 ≈ 10000 × 4000\|40000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|40000000\|55818126\|55818126 ≈ 40000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|33 ÷ 3 = 11, not 10` | error_spotting_generator.py |
...
| `MEAN_DIV` | 3 | `MEAN_DIV\|69\|8\|8.625` | five_number_summary_generator.py, simple_stats_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 4x + 6 = 2\|line 3 shows 4x = -4` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(39, 5)\|P(X < 37)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 9x^5 - 9x^4) / (3x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-9x^5) / (3x^2) + (-9x^4) / (3x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x - 3)(4x^2 - 4x + 1)` | multiplying_polynomials_generator.py |
...
| `QUARTILE` | 3 | `QUARTILE\|Q1\|5,14,21,25,31,32,32\|25` | five_number_summary_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ -3·(-1/3)^n, n ≥ 0\|converge or diverge? find the sum if it converges` | power_series_generator.py, series_convergence_generator.py |
...
| `SORT` | 2 | `SORT\|1,7,1,5,15,18,17,5\|1,1,5,5,7,15,17,18` | five_number_summary_generator.py, simple_stats_generator.py |
...
| `TEST_CHOOSE` | 2 | `TEST_CHOOSE\|geometric series\|common ratio r = -1/3` | power_series_generator.py, series_convergence_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(37 - 39)/5\|-0.40` | normal_table_generator.py |
