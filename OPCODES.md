...
273 distinct op-codes observed.
...
| `CHECK` | 3 | `CHECK\|multiply_back\|23×98+45=2299\|2299` | error_spotting_generator.py, factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, long_division_generator.py, quadratic_factoring_generator.py, ratio_table_generator.py, special_solution_equation_generator.py, systems_elimination_generator.py, tip_bill_split_generator.py, two_step_equation_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|- 8x^3 - 10x^2 + 4x` | multiplying_polynomials_generator.py |
...
| `EQ_RESULT` | 2 | `EQ_RESULT\|x\|-8` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, one_step_equation_generator.py, quadratic_factoring_generator.py, special_solution_equation_generator.py, two_step_equation_generator.py |
| `EQ_SETUP` | 1 | `EQ_SETUP\|x = 45/3` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, literal_equation_generator.py, one_step_equation_generator.py, proportion_word_problem_generator.py, quadratic_factoring_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py, two_step_equation_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|96494 × 83829 ≈ 100000 × 80000\|8000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|8000000000\|8088995526\|8088995526 ≈ 8000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|30 - 6 = 24, not 16` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-5x) * (7x)\|-35x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (2) * (7x)\|14x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (2) * (-9)\|-18` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-5x) * (-9)\|45x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(-5x + 2)(7x - 9)` | multiplying_binomials_generator.py |
| `FORM_IDENTIFY` | 2 | `FORM_IDENTIFY\|difference_of_squares\|a^2 - b^2 = (a - b)(a + b)` | factor_special_forms_generator.py |
...
| `MOVE_TERM` | 3 | `MOVE_TERM\|+4x\|left\|-4x+9-4x = +4` | linear_complex_generator.py, quadratic_factoring_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 7.02\|line 4 answers $46.02` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(48, 9)\|P(58.8 < X < 61.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 18x^5 - 45x^3 + 45x^3 - 27x^2) / (-9x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-18x^5) / (-9x^2) + (-45x^3) / (-9x^2) + (45x^3) / (-9x^2) + (-27x^2) / (-9x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x + 1)(-4x^2 - 5x + 2)` | multiplying_polynomials_generator.py |
...
| `REWRITE` | 1 | `REWRITE\|8 + 90` | evaluate_expression_generator.py, exponent_mixed_rules_generator.py, factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, linear_complex_generator.py, linear_fractional_generator.py, literal_equation_generator.py, normal_table_generator.py, order_of_operations_generator.py, quadratic_factoring_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
| `ROOT` | 2 | `ROOT\|5625\|75` | factor_special_forms_generator.py, pythag_hyp_generator.py, quadratic_generator.py, round_solids_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|Φ(1.20)\|0.8849` | normal_table_generator.py |
