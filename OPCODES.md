...
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|12x^3 + 12x^2 + 15x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|53096 × 27876 ≈ 50000 × 30000\|1500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1500000000\|1480104096\|1480104096 ≈ 1500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | circle_equation_generator.py, complex_division_generator.py, conic_standard_form_generator.py, dot_product_generator.py, ellipse_features_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, hyperbola_features_generator.py, log_conversion_generator.py, log_properties_generator.py, parabola_features_generator.py, polar_parametric_generator.py, recursive_explicit_generator.py, regular_polygon_area_generator.py, remainder_factor_theorem_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, vector_ops_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-20 - 4 = -24, not -40` | error_spotting_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[-1, 1], [0, 6]]\|2A` | matrix_ops_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 13, giving 28\|line 4 divides by 7` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(49, 4)\|P(X < 57.8)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(2x^5 - 2x) / (2x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(2x^5) / (2x) + (-2x) / (2x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x + 1)(-4x^2 - 4x - 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(57.8 - 49)/4\|2.20` | normal_table_generator.py |
