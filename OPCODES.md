...
| `DEQUANT_VALUE` | 2 | `DEQUANT_VALUE\|1\|46/25` | quantization_generator.py |
...
| `QUANT_SETUP` | 3 | `QUANT_SETUP\|x=(91/50,-48/25,-181/100)\|scale=1/25\|zero_point=0` | quantization_generator.py |
| `QUANT_VALUE` | 2 | `QUANT_VALUE\|1\|46` | quantization_generator.py |
...
| `ROUND` | 2 | `ROUND\|91/2\|46` | quantization_generator.py |
