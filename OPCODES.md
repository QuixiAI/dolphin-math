...
547 distinct op-codes observed.
...
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|32*x^3*y^3 + 3*y^4` | gradient_generator.py, hessian_classify_generator.py, lagrange_multiplier_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py |
