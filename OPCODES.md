...
419 distinct op-codes observed.
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|16x^3\|4x^4` | antiderivative_generator.py, area_between_curves_generator.py, definite_integral_generator.py, integration_by_parts_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|45244 × 42070 ≈ 50000 × 40000\|2000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2000000000\|1903415080\|1903415080 ≈ 2000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-42 ÷ 7 = -6, not -8` | error_spotting_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (16x^3 - 9x^2 - 4x) dx\|antiderivative` | antiderivative_generator.py, definite_integral_generator.py, integration_by_parts_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 55:66\|line 3 divides 72 by 6` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(43, 8)\|P(47.8 < X < 48.6)` | normal_table_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(-4x + 3)/(x - 2)^2 = A/(x - 2) + B/(x - 2)^2` | partial_fractions_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 9x^2 + 18x) / (9x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-9x^2) / (9x) + (18x) / (9x)` | polynomial_div_monomial_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(47.8 - 43)/8\|0.60` | normal_table_generator.py |
