...
618 distinct op-codes observed.
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 1], [2, 1]]\|D = [[-2, 0], [0, -1]]\|P^-1 = [[-1, 1], [2, -1]]` | diagonalization_generator.py |
...
| `EIGENVALUE` | 2 | `EIGENVALUE\|λ = -3\|p(-3) = 0` | diagonalization_generator.py, eigenvalue_generator.py |
| `EIGENVECTOR` | 2 | `EIGENVECTOR\|A + 3I times v = 0\|[3, -2]` | diagonalization_generator.py, eigenvalue_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[6, -4], [3, -2]]\|4A` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py |
