...
| `COEFFS` | 1, 2 | `COEFFS\|3, -14, 13, 2` | synthetic_division_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|16x^3 + 8x^2 - 8x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|19299 × 7212 ≈ 20000 × 7000\|140000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|140000000\|139184388\|139184388 ≈ 140000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-14 - 7 = -21, not -18` | error_spotting_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(72, 14)\|P(X < 104.2)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^5 + 6x^2) / (-6x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^5) / (-6x) + (6x^2) / (-6x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x + 3)(-4x^2 - 2x + 2)` | multiplying_polynomials_generator.py |
...
| `REWRITE` | 1 | `REWRITE\|8 + 90` | completing_square_generator.py, complex_division_generator.py, complex_number_ops_generator.py, domain_range_generator.py, evaluate_expression_generator.py, exponent_mixed_rules_generator.py, factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, function_composition_generator.py, function_operations_generator.py, inverse_function_generator.py, linear_complex_generator.py, linear_fractional_generator.py, literal_equation_generator.py, normal_table_generator.py, order_of_operations_generator.py, quadratic_factoring_generator.py, radical_add_sub_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py, rational_equation_generator.py, rational_exponent_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py, synthetic_division_generator.py |
...
| `SYN_DROP` | 1 | `SYN_DROP\|3` | synthetic_division_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(104.2 - 72)/14\|2.30` | normal_table_generator.py |
