...
395 distinct op-codes observed.
...
| `DIST` | 3 | `DIST\|3\|-4x+3\|-12x+9` | derivative_limit_def_generator.py, equation_from_two_points_generator.py, function_composition_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, polar_parametric_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_expr_add_sub_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|- 8x^3 - 8x^2 + 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|74216 × 17033 ≈ 70000 × 20000\|1400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1400000000\|1264121128\|1264121128 ≈ 1400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|11 × 10 = 110, not 120` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 3x - 3 = -24\|line 3 shows 3x = -21` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(167, 5)\|P(X > 169)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 2x^6 - 10x^5) / (-2x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-2x^6) / (-2x^2) + (-10x^5) / (-2x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x - 2)(-4x^2 - 4x + 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(169 - 167)/5\|0.40` | normal_table_generator.py |
