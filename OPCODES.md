...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|- 3x^3 - 3x^2 + 3x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|97759 × 73877 ≈ 100000 × 70000\|7000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|7000000000\|7222141643\|7222141643 ≈ 7000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-68 + 12 = -56, not -48` | error_spotting_generator.py |
...
| `LIMIT_SETUP` | 2 | `LIMIT_SETUP\|lim x→1⁺ of abs(x - 1)/(x - 1)\|one-sided: approach from the right` | derivative_limit_def_generator.py, lhopital_generator.py, limit_evaluation_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 8\|line 5 answers 32` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(171, 7)\|P(X > 183.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(14x^5 - 7x^5) / (-7x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(14x^5) / (-7x) + (-7x^5) / (-7x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 5)(-3x^2 - 3x + 3)` | multiplying_polynomials_generator.py |
...
| `POWER_RULE` | 2 | `POWER_RULE\|3x^4\|12x^3` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, lhopital_generator.py, linear_approx_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(183.6 - 171)/7\|1.80` | normal_table_generator.py |
