...
| `DIST_TERM` | 2 | `DIST_TERM\|-5x\|- 20x^3 + 5x^2 + 25x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | arc_sector_generator.py, circle_equation_generator.py, complex_division_generator.py, conic_standard_form_generator.py, distance_formula_generator.py, ellipse_features_generator.py, exponential_equation_generator.py, exponential_model_generator.py, factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_mean_generator.py, geometric_sequence_generator.py, hyperbola_features_generator.py, hypercube_counting_generator.py, log_conversion_generator.py, log_equation_generator.py, log_properties_generator.py, piecewise_evaluation_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py, triangle_solve_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|90761 × 62897 ≈ 90000 × 60000\|5400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5400000000\|5708594617\|5708594617 ≈ 5400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-42 + 6 = -36, not -40` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 30:36\|line 3 divides 24 by 6` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(31, 9)\|P(X > 49.9)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(3x^2 + 4x^2 + 4x^2) / (x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(3x^2) / (x) + (4x^2) / (x) + (4x^2) / (x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-5x + 4)(4x^2 - x - 5)` | multiplying_polynomials_generator.py |
...
| `QUADRANT` | 2 | `QUADRANT\|53°\|quadrant I` | angle_measure_generator.py, unit_circle_generator.py |
...
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|7√7` | complex_quadratic_generator.py, distance_formula_generator.py, exponent_generator.py, geometric_mean_generator.py, hypercube_counting_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(5)\|18` | function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | circle_angle_generator.py, geometric_mean_generator.py, rational_root_generator.py, remainder_factor_theorem_generator.py, special_right_triangle_generator.py, triangle_solve_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|45-45-90 triangle, hypotenuse = 10\|leg` | special_right_triangle_generator.py, triangle_solve_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(49.9 - 31)/9\|2.10` | normal_table_generator.py |
