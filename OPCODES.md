...
| `ANTIDERIV` | 2 | `ANTIDERIV\|16x^3\|4x^4` | antiderivative_generator.py, definite_integral_generator.py, u_substitution_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-2x\|- 6x^3 - 8x^2 + 6x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|48851 × 37769 ≈ 50000 × 40000\|2000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2000000000\|1845053419\|1845053419 ≈ 2000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-18 - 14 = -32, not -24` | error_spotting_generator.py |
...
| `INTEG_RULE` | 2 | `INTEG_RULE\|power rule\|∫ x^n dx = x^(n+1)/(n+1) + C` | antiderivative_generator.py, definite_integral_generator.py, u_substitution_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 3:10\|line 4 multiplies 3 by 8` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(54, 4)\|P(61.6 < X < 62.8)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 12x^4 - 6x^4 + 12x^2) / (-6x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-12x^4) / (-6x) + (-6x^4) / (-6x) + (12x^2) / (-6x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x - 5)(3x^2 + 4x - 3)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(61.6 - 54)/4\|1.90` | normal_table_generator.py |
