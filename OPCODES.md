...
| `ARITH_SETUP` | 2 | `ARITH_SETUP\|A=1/2, B=1/4, C=1/4\|message=AABB` | arithmetic_coding_generator.py |
...
| `BACKPROP_SETUP` | 3 | `BACKPROP_SETUP\|x=(-2,2)\|y=1\|eta=1/7` | backprop_generator.py |
...
| `CANONICAL_ORDER` | 1 | `CANONICAL_ORDER\|A=2, E=2, C=3, F=3, G=3, B=4, D=4` | kraft_inequality_generator.py |
...
| `CRC_CHECK` | 3 | `CRC_CHECK\|codeword=111101111100\|remainder=000\|valid` | crc_generator.py |
| `CRC_REMAINDER` | 1 | `CRC_REMAINDER\|100` | crc_generator.py |
| `CRC_SETUP` | 3 | `CRC_SETUP\|data=111101111\|poly=1011\|augmented=111101111000` | crc_generator.py |
...
| `ENTROPY_SETUP` | 2, 3 | `ENTROPY_SETUP\|eigenvalues=[1/2,1/2]\|S=-sum lambda log2(lambda)` | entropy_change_generator.py, entropy_generator.py, huffman_coding_generator.py, mutual_information_generator.py, von_neumann_entropy_generator.py |
...
| `GAS_STOICH_SETUP` | 3 | `GAS_STOICH_SETUP\|mass_to_gas_pressure\|CaCO3 -> CaO + CO2\|given=1200 g CaCO3, gas=CO2` | gas_stoichiometry_generator.py |
...
| `GD_UPDATE` | 3 | `GD_UPDATE\|w_old=(3,-3)\|eta=1/7\|w_new=(71/21,-13/7)` | gradient_step_generator.py |
...
| `KL_SETUP` | 3 | `KL_SETUP\|P=[256/273,17/273]\|Q=[1/273,272/273]\|direction=Q to P` | kl_divergence_generator.py |
...
| `KRAFT_SETUP` | 2 | `KRAFT_SETUP\|A=2, B=4, C=3, D=4, E=2, F=3, G=3\|binary prefix code` | kraft_inequality_generator.py |
...
| `MSE_GRADIENT` | 2 | `MSE_GRADIENT\|g0=-8/3\|g1=-8` | gradient_step_generator.py |
| `MSE_SAMPLE` | 3 | `MSE_SAMPLE\|i=1\|pred=6\|r=1` | gradient_step_generator.py |
| `MSE_SETUP` | 3 | `MSE_SETUP\|model y_hat=w0+w1*x\|samples=[(-1,5), (3,-5), (2,1)]\|w=(3,-3), eta=1/7` | gradient_step_generator.py |
...
| `PARAMS` | 3 | `PARAMS\|W1=[[-1,1], [-2,2]]\|b1=(0,0)\|v=(2,-1), c=-2` | backprop_generator.py |
...
| `PERCEPTRON_SETUP` | 3 | `PERCEPTRON_SETUP\|eta=2\|w=(-1,-1,1)\|samples=[(2,-2,-1), (1,2,1), (2,1,1)]` | perceptron_generator.py |
...
| `UPDATE` | 2 | `UPDATE\|W1_11\|-19/7` | backprop_generator.py |
