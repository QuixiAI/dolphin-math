...
479 distinct op-codes observed.
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 3/6, P(B) = 3/6, P(A ∩ B) = 1/6\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 66, disease=no 80\|sensitivity 5/6, specificity 7/8\|P(disease=no given test negative)` | conditional_probability_generator.py |
| `BINOM_FORMULA` | 1 | `BINOM_FORMULA\|P(X ≤ k) = Σ C(n,i)·p^i·(1-p)^(n-i)` | binomial_probability_generator.py |
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 5, p = 7/10\|P(X ≤ 1)` | binomial_probability_generator.py |
...
| `CEIL` | 2 | `CEIL\|106.172416\|107` | confidence_interval_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 9, 7, 12, 12; expected: 10 each\|goodness of fit; df = 3, critical value = 7.815` | chi_square_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(9, 4)\|n!/(r!·(n-r)!)` | permutation_combination_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 13, no/bike 5, yes/bus 18, no/bus 11\|P(commute=bus given club=yes)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|club=yes total\|13 + 18 = 31` | conditional_probability_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|1x^3 + 5x^2 - 3x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|68279 × 50853 ≈ 70000 × 50000\|3500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3500000000\|3472191987\|3472191987 ≈ 3500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P($-6) = 2/5; P($10) = 1/5; P($5) = 1/5; P($-5) = 1/5\|expected value of the game` | expected_value_generator.py |
| `EXP_CELL` | 2 | `EXP_CELL\|(50·80)/100\|40` | chi_square_generator.py |
...
| `FACT_FORMULA` | 1 | `FACT_FORMULA\|3! = 1·2·3` | permutation_combination_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|99 ÷ 9 = 11, not 13` | error_spotting_generator.py |
...
| `FRAC_BUILD` | 2 | `FRAC_BUILD\|70/81\|70/81` | conditional_probability_generator.py |
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|-28/-33\|28/33` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
...
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 25, 17 successes, critical value = 2.326` | hypothesis_test_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 8:11\|line 4 multiplies 8 by 3` | fill_in_step_generator.py |
...
| `PERM_SETUP` | 2 | `PERM_SETUP\|arrange 4 of 7\|order matters` | permutation_combination_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 25x^6 + 25x^6 - 20x^4) / (-5x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-25x^6) / (-5x^2) + (25x^6) / (-5x^2) + (-20x^4) / (-5x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 5)(x^2 + 5x - 3)` | multiplying_polynomials_generator.py |
...
| `POW` | 2 | `POW\|(1/10)^6\|0.000001` | binomial_probability_generator.py |
...
| `TERM` | 2 | `TERM\|i=0: 1·(7/10)^0·(3/10)^5\|0.00243` | binomial_probability_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|2 - 3.4 = -1.4\|(-1.4)^2 = 1.96\|1/5·1.96 = 0.392` | expected_value_generator.py |
