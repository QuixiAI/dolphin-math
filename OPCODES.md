...
| `CHAR_EQ` | 2 | `CHAR_EQ\|assume y=e^(rx)\|r^2 + 5r + 4 = 0` | second_order_ode_generator.py, undetermined_coeff_generator.py |
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^2 + 4λ + 3\|(λ + 3)*(λ + 1)` | diagonalization_generator.py, eigenvalue_generator.py |
| `CHAR_ROOTS` | 2 | `CHAR_ROOTS\|r1 = -4, r2 = -1\|distinct real` | second_order_ode_generator.py, undetermined_coeff_generator.py |
...
| `DERIV_FORM` | 2 | `DERIV_FORM\|y'\|-4C1e^(-4x) - C2e^(-x)` | second_order_ode_generator.py, undetermined_coeff_generator.py |
...
| `FACTOR` | 2 | `FACTOR\|r^2 + 5r + 4\|(r + 4)(r + 1) = 0` | second_order_ode_generator.py, undetermined_coeff_generator.py |
...
| `HOM_SOL` | 2 | `HOM_SOL\|y_h\|y_h = C1e^(-x) + C2e^(3x)` | undetermined_coeff_generator.py |
...
| `ODE_SETUP` | 2 | `ODE_SETUP\|dy/dx = y^2, y(0) = 2\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, second_order_ode_generator.py, separable_ode_generator.py, undetermined_coeff_generator.py |
...
| `PARTICULAR` | 2 | `PARTICULAR\|y_p\|-3` | undetermined_coeff_generator.py |
...
| `SOLVE_Y` | 2 | `SOLVE_Y\|e^(4x)y = 4e^(6x) + C\|y = 4e^(2x) + Ce^(-4x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `SOL_FORM` | 1 | `SOL_FORM\|y = C1e^(-4x) + C2e^(-x)` | second_order_ode_generator.py, undetermined_coeff_generator.py |
