...
| `ADJ_LIST` | 2 | `ADJ_LIST\|A\|B, C, D, E` | graph_traversal_generator.py |
...
| `DEGREE` | 3 | `DEGREE\|A\|B, C, D, E\|4` | graph_counting_generator.py |
...
| `EDGE_COUNT` | 2 | `EDGE_COUNT\|m\|6` | graph_counting_generator.py |
...
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|directed adjacency matrix\|4 vertices` | dijkstra_generator.py, graph_counting_generator.py, graph_traversal_generator.py |
