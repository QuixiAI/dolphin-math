...
572 distinct op-codes observed.
...
| `DOT` | 3 | `DOT\|(15, 33) · (0, 1)\|15*0 + 33*1\|33` | gradient_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[6, -4], [3, -2]]\|4A` | determinant_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py |
...
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|32*x^3*y^3 + 3*y^4` | div_curl_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py |
...
| `ROW_OP` | 2 | `ROW_OP\|R2 → R2 - 3·R1\|[0, 1, 0, 3]` | row_reduction_generator.py |
