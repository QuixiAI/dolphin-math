...
518 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-2x\|8x^3 + 2x^2 + 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|54713 × 46089 ≈ 50000 × 50000\|2500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2500000000\|2521667457\|2521667457 ≈ 2500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-42 - 6 = -48, not -32` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 7.95\|line 4 answers $60.95` | fill_in_step_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(6x^6 + 30x^4 + 30x^2) / (6x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(6x^6) / (6x^2) + (30x^4) / (6x^2) + (30x^2) / (6x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x + 1)(-4x^2 - x - 1)` | multiplying_polynomials_generator.py |
