...
654 distinct op-codes observed.
...
| `CHAR_EQ` | 2 | `CHAR_EQ\|assume y=e^(rx)\|r^2 + 5r + 4 = 0` | second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `ODE_SETUP` | 2 | `ODE_SETUP\|dy/dx = y^2, y(0) = 2\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, second_order_ode_generator.py, separable_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `SOLVE_CONST` | 2 | `SOLVE_CONST\|C1 = 3\|C2 = -3` | second_order_ode_generator.py, undetermined_coeff_generator.py |
...
| `SOL_FORM` | 1 | `SOL_FORM\|y = C1e^(-4x) + C2e^(-x)` | second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
