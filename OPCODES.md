...
634 distinct op-codes observed.
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|8x^3\|2x^4` | antiderivative_generator.py, arc_length_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integrating_factor_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py |
...
| `IFACTOR` | 2 | `IFACTOR\|mu = e^(∫ 4 dx)\|e^(4x)` | integrating_factor_generator.py |
...
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(4x)y' + 4e^(4x)y\|24e^(6x)` | integrating_factor_generator.py |
...
| `ODE_SETUP` | 2 | `ODE_SETUP\|dy/dx = y^2, y(0) = 2\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, logistic_growth_generator.py, separable_ode_generator.py |
...
| `SOLVE_Y` | 2 | `SOLVE_Y\|e^(4x)y = 4e^(6x) + C\|y = 4e^(2x) + Ce^(-4x)` | integrating_factor_generator.py |
