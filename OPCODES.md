...
972 distinct op-codes observed.
...
| `MATRIX_PRODUCT` | 2 | `MATRIX_PRODUCT\|AB\|[[0, i/2], [i/2, 0]]` | structure_constant_generator.py |
...
| `MATRIX_VALUE` | 2 | `MATRIX_VALUE\|A\|[[0, -i], [i, 0]]` | structure_constant_generator.py |
