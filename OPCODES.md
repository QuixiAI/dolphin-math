...
| `CANCEL` | 2 | `CANCEL\|5y\|7y - 5` | limit_evaluation_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, rational_function_features_generator.py |
...
| `DIST` | 3 | `DIST\|3\|-4x+3\|-12x+9` | equation_from_two_points_generator.py, function_composition_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, polar_parametric_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_expr_add_sub_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|16x^3 + 4x^2 + 16x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|43136 × 26299 ≈ 40000 × 30000\|1200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1200000000\|1134433664\|1134433664 ≈ 1200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|45 ÷ 5 = 9, not 10` | error_spotting_generator.py |
...
| `LIMIT_SETUP` | 2 | `LIMIT_SETUP\|lim x→1⁺ of abs(x - 1)/(x - 1)\|one-sided: approach from the right` | limit_evaluation_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 2x = 18\|line 5 shows x = 9` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(509, 7)\|P(X > 523)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(21x^6 + 7x^3) / (7x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(21x^6) / (7x^3) + (7x^3) / (7x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x + 4)(-4x^2 - x - 4)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(523 - 509)/7\|2.00` | normal_table_generator.py |
