...
| `ACT_SETUP` | 3 | `ACT_SETUP\|activation=gelu\|x=3\|w1=-5,b1=15,w2=-2,b2=6` | activation_generator.py |
...
| `ADAM_SETUP` | 3 | `ADAM_SETUP\|theta=-9,g=7\|beta1=9/10,beta2=99/100\|lr=1/10,epsilon=0` | adam_step_generator.py |
| `ADAM_UPDATE` | 2 | `ADAM_UPDATE\|theta_new\|-91/10` | adam_step_generator.py |
...
| `APPROX` | 2 | `APPROX\|lora/full\|1/4` | param_count_generator.py |
...
| `FLOPS_SETUP` | 2 | `FLOPS_SETUP\|rule=2mnk\|m=8,d=64,h=128,o=512` | flops_memory_generator.py |
...
| `LORA_COUNT` | 2 | `LORA_COUNT\|r*(d_in+d_out)\|18432` | param_count_generator.py |
...
| `MEMORY_SETUP` | 3 | `MEMORY_SETUP\|kv_cache\|L=8,h=8,d_k=64\|seq=4096,precision_bytes=1` | flops_memory_generator.py |
| `MEMORY_UNIT` | 2 | `MEMORY_UNIT\|MiB\|32` | flops_memory_generator.py |
...
| `PARAM_PART` | 2 | `PARAM_PART\|full_matrix\|73728` | param_count_generator.py |
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(6*t - 2, 4*t - 1)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 2 cos t, y = 2 sin t\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PE_SETUP` | 3 | `PE_SETUP\|position=125\|d=2\|theta=3pi/2` | positional_encoding_generator.py |
