...
| `CENTROID_UPDATE` | 2 | `CENTROID_UPDATE\|C1\|(-3/2,2)` | kmeans_step_generator.py |
...
| `DIST2` | 3 | `DIST2\|P1\|C1\|68` | kmeans_step_generator.py |
...
| `IG_SETUP` | 3 | `IG_SETUP\|parent pos=2, neg=14\|total=16\|splits=size,texture` | information_gain_generator.py |
...
| `INFO_GAIN` | 2 | `INFO_GAIN\|size\|0.13825` | information_gain_generator.py |
...
| `KMEANS_SETUP` | 2 | `KMEANS_SETUP\|points=P1=(5,-2), P2=(-2,0), P3=(2,-3), P4=(-1,4)\|centroids=C1=(-3,0), C2=(5,-4)` | kmeans_step_generator.py |
| `KNN_DISTANCE` | 3 | `KNN_DISTANCE\|P1\|label=A\|d2=25` | knn_generator.py |
| `KNN_NEIGHBORS` | 1 | `KNN_NEIGHBORS\|P5:2:B,P3:5:A,P1:25:A` | knn_generator.py |
| `KNN_SETUP` | 3 | `KNN_SETUP\|q=(3,-1)\|k=3\|training=P1=(-1,-4,A), P2=(3,5,B), P3=(5,0,A), P4=(1,4,B), P5=(4,-2,B)` | knn_generator.py |
| `KNN_SORT` | 1 | `KNN_SORT\|P5:2:B,P3:5:A,P1:25:A,P4:29:B,P2:36:B` | knn_generator.py |
...
| `NB_FEATURE_COUNT` | 3 | `NB_FEATURE_COUNT\|Spam\|urgent=1\|count=5` | naive_bayes_generator.py |
| `NB_LIKELIHOOD` | 3 | `NB_LIKELIHOOD\|Spam\|urgent=1\|1/3` | naive_bayes_generator.py |
| `NB_PRIOR` | 2 | `NB_PRIOR\|Spam\|16/31` | naive_bayes_generator.py |
| `NB_SCORE` | 2 | `NB_SCORE\|Spam\|start=16/31` | naive_bayes_generator.py |
| `NB_SETUP` | 3 | `NB_SETUP\|query=urgent=1, long=1, known=0\|alpha=1\|classes=Spam,Ham` | naive_bayes_generator.py |
...
| `SPLIT_SETUP` | 3 | `SPLIT_SETUP\|size\|left pos=0, neg=8\|right pos=2, neg=6` | information_gain_generator.py |
