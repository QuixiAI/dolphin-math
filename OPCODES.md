...
1385 distinct op-codes observed.
...
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=3\|ln(2)` | softmax_gradient_generator.py |
...
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(-2,6)\|gamma=(1,1)\|beta=(5,3)` | layer_norm_generator.py |
...
| `SOFTMAX_SETUP` | 3 | `SOFTMAX_SETUP\|z=(2*ln(3),2*ln(6),2*ln(9))\|T=2\|target=3` | softmax_gradient_generator.py |
...
| `VARIANCE` | 1, 2 | `VARIANCE\|Delta x^2\|1/12 - 1/(14450pi^2)` | layer_norm_generator.py, uncertainty_generator.py |
