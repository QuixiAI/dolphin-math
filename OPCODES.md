...
392 distinct op-codes observed.
...
| `DET_FORMULA` | 1 | `DET_FORMULA\|det = ad - bc` | determinant_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|5x^3 - 2x^2 - 5x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|65295 × 20280 ≈ 70000 × 20000\|1400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1400000000\|1324182600\|1324182600 ≈ 1400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | circle_equation_generator.py, complex_division_generator.py, conic_standard_form_generator.py, determinant_generator.py, dot_product_generator.py, ellipse_features_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, hyperbola_features_generator.py, log_conversion_generator.py, log_properties_generator.py, parabola_features_generator.py, polar_parametric_generator.py, recursive_explicit_generator.py, regular_polygon_area_generator.py, remainder_factor_theorem_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, vector_ops_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-11 - 10 = -21, not -35` | error_spotting_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(75, 8)\|P(79.8 < X < 85.4)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 28x^6 + 28x^6 + 28x^3) / (-7x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-28x^6) / (-7x^2) + (28x^6) / (-7x^2) + (28x^3) / (-7x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 5)(5x^2 - 2x - 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(79.8 - 75)/8\|0.60` | normal_table_generator.py |
