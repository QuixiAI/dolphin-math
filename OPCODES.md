...
| `EIGENVALUES` | 2 | `EIGENVALUES\|A^T A\|49,64` | matrix_norm_generator.py |
...
| `GRAD_ENTRY` | 2 | `GRAD_ENTRY\|g1\|-10` | matrix_calculus_generator.py |
...
| `MAT_ENTRY` | 2, 3 | `MAT_ENTRY\|(1,1)\|24` | lie_exponential_generator.py, matrix_calculus_generator.py, matrix_ops_generator.py |
...
| `MAX` | 2, 3 | `MAX\|8, 11\|11` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
| `MAXTERM` | 2 | `MAXTERM\|000\|A OR B OR C` | boolean_algebra_generator.py |
| `MC_SETUP` | 3 | `MC_SETUP\|expression=x^T A x\|A=[[3,4], [-3,0]]\|x=(-1,-4)` | matrix_calculus_generator.py |
...
| `METRICS_SETUP` | 1 | `METRICS_SETUP\|TP=13, FP=30, FN=9, TN=41` | classifier_metrics_generator.py |
...
| `MIN` | 2 | `MIN\|49,64\|49` | matrix_norm_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|A: 124 in N(112, 5)\|compare relative standing` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
...
| `PD_SETUP` | 2 | `PD_SETUP\|A=[[25,10], [10,8]]\|Sylvester criterion` | positive_definite_generator.py |
