...
| `EIGENVALUES` | 2 | `EIGENVALUES\|A^T A\|49,64` | matrix_norm_generator.py, pca_generator.py |
...
| `PCA_SETUP` | 2 | `PCA_SETUP\|points=[(1,4), (-5,4), (-2,10), (-2,-2)]\|population covariance` | pca_generator.py |
