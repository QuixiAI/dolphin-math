...
723 distinct op-codes observed.
...
| `EDGE_WEIGHT` | 2 | `EDGE_WEIGHT\|AB\|2` | dijkstra_generator.py |
...
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|directed adjacency matrix\|4 vertices` | dijkstra_generator.py, graph_counting_generator.py |
