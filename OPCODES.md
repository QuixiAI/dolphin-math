...
| `GCD_RESULT` | 1, 2 | `GCD_RESULT\|2` | lcm_generator.py, modular_inverse_generator.py, rsa_generator.py, totient_generator.py |
...
| `GROUP_SETUP` | 2, 3 | `GROUP_SETUP\|Z_13\|addition mod n` | cayley_table_generator.py, cyclic_group_generator.py |
...
| `SUBGROUP_ELEM` | 2 | `SUBGROUP_ELEM\|k=1\|15` | cyclic_group_generator.py |
