...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|6x^3 + 12x^2 + 12x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|88595 × 45557 ≈ 90000 × 50000\|4500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|4500000000\|4036122415\|4036122415 ≈ 4500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|35 ÷ 7 = 5, not 7` | error_spotting_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(35, 5)\|P(X < 41.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(9x^7 + 36x^6 + 9x^6 - 36x^4) / (9x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(9x^7) / (9x^3) + (36x^6) / (9x^3) + (9x^6) / (9x^3) + (-36x^4) / (9x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x - 1)(2x^2 + 4x + 4)` | multiplying_polynomials_generator.py |
...
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | geometric_mean_generator.py, rational_root_generator.py, remainder_factor_theorem_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(41.5 - 35)/5\|1.30` | normal_table_generator.py |
