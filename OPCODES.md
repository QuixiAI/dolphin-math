...
| `ACCEPT` | 2 | `ACCEPT\|(3, -9)\|product -27 ✓, sum -6 ✓` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|16x^3\|4x^4` | antiderivative_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|5x\|25x^3 + 10x^2 - 10x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|38157 × 20404 ≈ 40000 × 20000\|800000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|800000000\|778555428\|778555428 ≈ 800000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|12 × 4 = 48, not 52` | error_spotting_generator.py |
...
| `INTEG_RULE` | 2 | `INTEG_RULE\|power rule\|∫ x^n dx = x^(n+1)/(n+1) + C` | antiderivative_generator.py |
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (16x^3 - 9x^2 - 4x) dx\|antiderivative` | antiderivative_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 2x on [1, 4]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + x - 6 on [-3, 5]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `NCR` | 2 | `NCR\|C(5,1)\|5` | hypercube_counting_generator.py |
| `NEED` | 2 | `NEED\|line 2 adds 6, giving -63\|line 4 divides by 7` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(59, 8)\|P(75.8 < X < 77.4)` | normal_table_generator.py |
| `OPT_SETUP` | 2 | `OPT_SETUP\|x + y = 18, x, y > 0\|maximize P = x·y^2` | optimization_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 21x^6 + 35x^2 - 35x^2) / (-7x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-21x^6) / (-7x^2) + (35x^2) / (-7x^2) + (-35x^2) / (-7x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(5x - 4)(5x^2 + 2x - 2)` | multiplying_polynomials_generator.py |
...
| `POWER_RULE` | 2 | `POWER_RULE\|3x^4\|12x^3` | chain_rule_generator.py, curve_analysis_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, lhopital_generator.py, linear_approx_generator.py, log_diff_higher_order_generator.py, mean_value_theorem_generator.py, optimization_generator.py, tangent_line_generator.py |
...
| `SUBST` | 3 | `SUBST\|x\|-5\|2(-5)+5y+7` | chain_rule_generator.py, curve_analysis_generator.py, derivative_limit_def_generator.py, evaluate_expression_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, implicit_diff_generator.py, lhopital_generator.py, limit_evaluation_generator.py, linear_approx_generator.py, log_diff_higher_order_generator.py, mean_value_theorem_generator.py, optimization_generator.py, piecewise_evaluation_generator.py, polar_parametric_generator.py, recursive_explicit_generator.py, related_rates_generator.py, remainder_factor_theorem_generator.py, tangent_line_generator.py, trig_equation_generator.py |
...
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | circle_angle_generator.py, geometric_mean_generator.py, mean_value_theorem_generator.py, polar_parametric_generator.py, rational_root_generator.py, remainder_factor_theorem_generator.py, special_right_triangle_generator.py, triangle_solve_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py |
