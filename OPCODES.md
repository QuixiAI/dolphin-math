...
1419 distinct op-codes observed.
...
| `NLL` | 2 | `NLL\|175 tokens\|175*ln(4)` | perplexity_generator.py |
...
| `PERPLEXITY_SETUP` | 2 | `PERPLEXITY_SETUP\|tokens=175\|p=1/4` | perplexity_generator.py |
