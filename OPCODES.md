...
687 distinct op-codes observed.
...
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^2 + 4λ + 3\|(λ + 3)*(λ + 1)` | diagonalization_generator.py, eigenvalue_generator.py |
| `CHAR_ROOTS` | 2 | `CHAR_ROOTS\|r1 = -4, r2 = -1\|distinct real` | second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `RECURRENCE` | 2 | `RECURRENCE\|a_(n+1)\|-3a_n/(n+1)` | series_solution_generator.py |
...
| `SHIFT` | 2 | `SHIFT\|yi = xi - 1\|y1+...+y5 = 2` | stars_and_bars_generator.py |
