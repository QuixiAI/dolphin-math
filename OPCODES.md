...
340 distinct op-codes observed.
...
| `CENTER` | 1 | `CENTER\|(3, 6)` | ellipse_features_generator.py |
...
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(x + 2)^2 = -16(y + 1)\|vertex, focus, directrix` | ellipse_features_generator.py, parabola_features_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-x\|- 4x^3 + 3x^2 + 1x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | complex_division_generator.py, ellipse_features_generator.py, exponential_equation_generator.py, exponential_model_generator.py, factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_sequence_generator.py, log_conversion_generator.py, log_equation_generator.py, log_properties_generator.py, piecewise_evaluation_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|42799 × 26863 ≈ 40000 × 30000\|1200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1200000000\|1149709537\|1149709537 ≈ 1200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | complex_division_generator.py, ellipse_features_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, log_conversion_generator.py, log_properties_generator.py, parabola_features_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|50 ÷ 5 = 10, not 11` | error_spotting_generator.py |
| `FOCUS` | 1 | `FOCUS\|(-2, -5)` | ellipse_features_generator.py, parabola_features_generator.py |
...
| `FORM_IDENTIFY` | 2 | `FORM_IDENTIFY\|difference_of_squares\|a^2 - b^2 = (a - b)(a + b)` | completing_square_generator.py, ellipse_features_generator.py, factor_special_forms_generator.py, parabola_features_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_equation_generator.py, rational_exponent_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 9x + 2 = 11\|line 3 shows 9x = 9` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(503, 12)\|P(X < 499.4)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 3x^3 + 9x) / (-3x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-3x^3) / (-3x) + (9x) / (-3x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x - 4)(4x^2 - 3x - 1)` | multiplying_polynomials_generator.py |
...
| `VERTEX` | 1 | `VERTEX\|(-2, -1)` | ellipse_features_generator.py, parabola_features_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(499.4 - 503)/12\|-0.30` | normal_table_generator.py |
