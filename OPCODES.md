...
| `COMPARE` | 3 | `COMPARE\|arr[0]=34\|key 26\|shift` | algorithm_trace_generator.py |
...
| `MATRIX_PRODUCT` | 2 | `MATRIX_PRODUCT\|AB\|[[0, i/2], [i/2, 0]]` | bch_generator.py, casimir_generator.py, pauli_algebra_generator.py, structure_constant_generator.py |
...
| `TRACE_EXPECT` | 1 | `TRACE_EXPECT\|Tr(rho A)=p0*a+p1*b` | density_matrix_generator.py |
