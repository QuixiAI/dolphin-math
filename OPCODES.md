...
816 distinct op-codes observed.
...
| `MOD_POWER` | 3 | `MOD_POWER\|29^3\|mod 5\|4` | rsa_generator.py, totient_generator.py |
| `MOD_REDUCE` | 3 | `MOD_REDUCE\|169\|mod 11\|4` | calendar_arithmetic_generator.py, crt_generator.py, mod_exp_generator.py, modular_arithmetic_generator.py, modular_inverse_generator.py, quadratic_residue_generator.py, rsa_generator.py, totient_generator.py |
