...
| `DERIV` | 2, 3 | `DERIV\|d_phi g_thetatheta\|2R^2 sin(phi)cos(phi)` | christoffel_generator.py |
...
| `FORMULA` | 1 | `FORMULA\|sinh x = (e^x - e^(-x))/2` | hyperbolic_distance_generator.py, hyperbolic_function_generator.py, stereographic_generator.py |
