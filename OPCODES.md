...
408 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|12x^3 + 12x^2 - 20x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|22440 × 2796 ≈ 20000 × 3000\|60000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|60000000\|62742240\|62742240 ≈ 60000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-36 ÷ 9 = -4, not -6` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 5, giving -56\|line 4 divides by 8` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(47, 10)\|P(X < 37)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 16x^2 + 32x - 16x) / (-8x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-16x^2) / (-8x) + (32x) / (-8x) + (-16x) / (-8x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x + 1)(-3x^2 - 3x + 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(37 - 47)/10\|-1.00` | normal_table_generator.py |
