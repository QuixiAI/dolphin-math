...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|- 15x^3 + 3x^2 - 6x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | arc_sector_generator.py, circle_equation_generator.py, complex_division_generator.py, conic_standard_form_generator.py, distance_formula_generator.py, ellipse_features_generator.py, exponential_equation_generator.py, exponential_model_generator.py, factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_mean_generator.py, geometric_sequence_generator.py, hyperbola_features_generator.py, hypercube_counting_generator.py, log_conversion_generator.py, log_equation_generator.py, log_properties_generator.py, piecewise_evaluation_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|91226 × 64414 ≈ 90000 × 60000\|5400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5400000000\|5876231564\|5876231564 ≈ 5400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|56 ÷ 7 = 8, not 10` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 6x = -30\|line 5 shows x = -5` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(40, 9)\|P(X < 29.2)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(5x^5 + 4x^4) / (x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(5x^5) / (x^2) + (4x^4) / (x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x + 3)(-5x^2 + x - 2)` | multiplying_polynomials_generator.py |
...
| `SIGN_RULE` | 2 | `SIGN_RULE\|sin, quadrant I\|positive` | unit_circle_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(5)\|18` | function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, right_triangle_trig_generator.py, unit_circle_generator.py |
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | circle_angle_generator.py, geometric_mean_generator.py, rational_root_generator.py, remainder_factor_theorem_generator.py, special_right_triangle_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle, angle 24°, hypotenuse = 20; given sin 24° ≈ 0.4\|the opposite side` | right_triangle_trig_generator.py, unit_circle_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|45-45-90 triangle, hypotenuse = 10\|leg` | special_right_triangle_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(29.2 - 40)/9\|-1.20` | normal_table_generator.py |
