...
633 distinct op-codes observed.
...
| `ODE_SETUP` | 2 | `ODE_SETUP\|dy/dx = y^2, y(0) = 2\|solve` | euler_method_generator.py, integrating_factor_generator.py, logistic_growth_generator.py, separable_ode_generator.py |
