...
627 distinct op-codes observed.
...
| `EIGENVALUE` | 2 | `EIGENVALUE\|λ = -3\|p(-3) = 0` | diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py |
| `EIGENVECTOR` | 2 | `EIGENVECTOR\|A + 3I times v = 0\|[3, -2]` | diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[6, -4], [3, -2]]\|4A` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py |
