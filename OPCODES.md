...
319 distinct op-codes observed.

| Code | Payload fields | Example | Used by |
|---|---|---|---|
| `A` | 3 | `A\|27\|2\|29` | arithmetic_sequence_generator.py, complex_division_generator.py, complex_number_ops_generator.py, evaluate_expression_generator.py, fill_in_step_generator.py, fraction_op_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometry_area_perimeter_generator.py, graph_interpret_generator.py, horner_evaluation_generator.py, mixed_number_operation_generator.py, order_of_operations_generator.py, pascal_triangle_generator.py, percent_word_problem_generator.py, piecewise_evaluation_generator.py, polygon_perimeter_generator.py, pythag_hyp_generator.py, radical_add_sub_generator.py, radical_multiply_generator.py, rational_expr_add_sub_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py, sigma_notation_generator.py, simple_stats_generator.py, synthetic_division_generator.py, temperature_conversion_generator.py, tip_bill_split_generator.py |
...
| `ACCEPT` | 2 | `ACCEPT\|(3, -9)\|product -27 ✓, sum -6 ✓` | factor_trinomial_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `COEFFS` | 1, 2 | `COEFFS\|3, -14, 13, 2` | horner_evaluation_generator.py, synthetic_division_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|3x^3 - 1x^2 + 5x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | complex_division_generator.py, factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_sequence_generator.py, piecewise_evaluation_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|83437 × 74457 ≈ 80000 × 70000\|5600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5600000000\|6212468709\|6212468709 ≈ 5600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | complex_division_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|40 ÷ 8 = 5, not 6` | error_spotting_generator.py |
...
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|f(t) = 3t + 3\|f(5)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py |
...
| `M` | 2, 3 | `M\|6\|99\|594` | arithmetic_sequence_generator.py, decimal_div_generator.py, dimensional_analysis_generator.py, error_spotting_generator.py, evaluate_expression_generator.py, factor_special_forms_generator.py, fill_in_step_generator.py, fraction_op_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_sequence_generator.py, geometry_area_perimeter_generator.py, graph_interpret_generator.py, horner_evaluation_generator.py, long_division_generator.py, mixed_number_operation_generator.py, multi_step_unit_conversion_generator.py, order_of_operations_generator.py, percent_problem_generator.py, percent_word_problem_generator.py, piecewise_evaluation_generator.py, proportion_word_problem_generator.py, proportional_relationship_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rate_conversion_generator.py, ratio_table_generator.py, rational_equation_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py, synthetic_division_generator.py, temperature_conversion_generator.py, tip_bill_split_generator.py, unit_conversion_generator.py, volume_rect_prism_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 9x - 8 = -17\|line 3 shows 9x = -9` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(485, 6)\|P(X < 493.4)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(8x^5 - 16x^3 + 40x^2 + 32x) / (8x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(8x^5) / (8x) + (-16x^3) / (8x) + (40x^2) / (8x) + (32x) / (8x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 1)(3x^2 - x + 5)` | multiplying_polynomials_generator.py |
...
| `R` | 1 | `R\|21` | complex_number_ops_generator.py, long_division_generator.py, polynomial_long_division_generator.py, synthetic_division_generator.py |
...
| `REJECT` | 2 | `REJECT\|(1, -27)\|sum is -26, need -6` | factor_trinomial_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
| `REWRITE` | 1 | `REWRITE\|8 + 90` | completing_square_generator.py, complex_division_generator.py, complex_number_ops_generator.py, domain_range_generator.py, evaluate_expression_generator.py, exponent_mixed_rules_generator.py, factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, inverse_function_generator.py, linear_complex_generator.py, linear_fractional_generator.py, literal_equation_generator.py, normal_table_generator.py, order_of_operations_generator.py, quadratic_factoring_generator.py, radical_add_sub_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py, rational_equation_generator.py, rational_exponent_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py, synthetic_division_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|3x^3 - 14x^2 + 13x + 2\|r = 3` | synthetic_division_generator.py |
| `SYN_DROP` | 1 | `SYN_DROP\|3` | horner_evaluation_generator.py, synthetic_division_generator.py |
| `SYN_ROW` | 1 | `SYN_ROW\|3, -5, -2, -4` | synthetic_division_generator.py |
...
| `TRY` | 2 | `TRY\|(1, -27)\|1·(-27)=-27, 1+(-27)=-26` | factor_trinomial_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(493.4 - 485)/6\|1.40` | normal_table_generator.py |
