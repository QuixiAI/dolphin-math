...
| `COUNT` | 2 | `COUNT\|A = [4, 5, 6]\|3/6` | method_of_moments_generator.py, mle_generator.py, probability_addition_rule_generator.py, set_operations_generator.py |
...
| `FACT` | 2 | `FACT\|10\|3628800` | named_distribution_generator.py, young_tableaux_generator.py |
...
| `ITERATE` | 2 | `ITERATE\|n=1\|z=(7/2,-3)` | fractal_iteration_generator.py |
...
| `SUM` | 2, 3 | `SUM\|29 + 31 + 37 + 33 + 35\|165` | method_of_moments_generator.py, mle_generator.py, regression_generator.py |
