...
360 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|- 8x^3 + 8x^2 + 16x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|59235 × 39832 ≈ 60000 × 40000\|2400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2400000000\|2359448520\|2359448520 ≈ 2400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-22 + 6 = -16, not -14` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 7x = -49\|line 5 shows x = -7` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(489, 11)\|P(504.4 < X < 513.2)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(6x^6 - 8x^6 - 4x^5 - 8x^4) / (2x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(6x^6) / (2x^2) + (-8x^6) / (2x^2) + (-4x^5) / (2x^2) + (-8x^4) / (2x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x - 2)(2x^2 - 2x - 4)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(504.4 - 489)/11\|1.40` | normal_table_generator.py |
