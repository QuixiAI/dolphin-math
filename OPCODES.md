...
457 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|3x^3 + 5x^2 - 5x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|78447 × 27628 ≈ 80000 × 30000\|2400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2400000000\|2167333716\|2167333716 ≈ 2400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-10 + 8 = -2, not -6` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 18% to 0.18\|line 3 adds the tip 13.68 to the bill` | fill_in_step_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 3x^4 + 12x^4) / (3x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-3x^4) / (3x^3) + (12x^4) / (3x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 1)(3x^2 + 5x - 5)` | multiplying_polynomials_generator.py |
