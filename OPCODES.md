...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|4x + 1 = 4` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|x + 4 >= 15 -> x >= 11` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|4x - 1\| < 20` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for >` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|AND case\|-20 < 4x - 1 < 20` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|5x - 6\| = 0` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Single case\|5x - 6 = 0` | absolute_value_equation_generator.py |
...
| `ANGLE_RELATION` | 1 | `ANGLE_RELATION\|6x + 36 = 90` | angle_relationships_generator.py |
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|complementary\|(2x)° + (4x + 36)° = 90°` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|6x = 54\|x = 9` | angle_relationships_generator.py |
...
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|C = 30π\|30π` | circle_generator.py |
| `CIRCLE_FORMULA` | 1 | `CIRCLE_FORMULA\|C = 2πr` | circle_generator.py |
| `CIRCLE_SETUP` | 2 | `CIRCLE_SETUP\|15\|radius` | circle_generator.py |
| `CIRCLE_SUBSTITUTE` | 1 | `CIRCLE_SUBSTITUTE\|C = 2 × π × 15` | circle_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|2x + 7 < 3 -> x < -2` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|-14 < 4x - 2 < 26` | compound_inequality_generator.py |
...
| `DISC` | 3 | `DISC\|729\|648\|81` | quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|3y + 0 = 0` | systems_substitution_generator.py |
...
| `E` | 3 | `E\|36\|2\|1296` | pythag_hyp_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-5, -1)\|(-3, -3)` | equation_from_two_points_generator.py |
...
| `FOIL_F` | 2 | `FOIL_F\|First: (-1x) * (-3x)\|3x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-1) * (-3x)\|3x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (-1) * (1)\|-1` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-1x) * (1)\|-1x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(-x - 1)(-3x + 1)` | multiplying_binomials_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|1\|-19 < 4x < 21` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = -2x - 6\|(10, 8)` | parallel_perpendicular_line_generator.py |
...
| `MONO_ADD_EXP` | 2 | `MONO_ADD_EXP\|x^3 * x^3 = x^(3+3)\|x^6` | monomial_mult_div_generator.py |
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|-6 / -1\|6` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|-3 * 2\|-6` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-3x^3)(2x^3)` | monomial_mult_div_generator.py |
...
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|(2x + 27) + (5x + 76) = 180` | angle_relationships_generator.py |
...
| `PARALLEL_SOLVE` | 2 | `PARALLEL_SOLVE\|7x + 103 = 180\|x = 11` | angle_relationships_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-9x^3 - 3x^2 + 16x - 1` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^7 - 12x^7 + 3x^6) / (3x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^7) / (3x^3) + (-12x^7) / (3x^3) + (3x^6) / (3x^3)` | polynomial_div_monomial_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-9x^3) + (1x^2 -4x^2) + (9x +7x) + (-1)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-5x + 4)(x^2 + x - 2)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1 | `POLY_SETUP\|(-9x^3 + x^2 + 9x - 1) + (-4x^2 + 7x)` | polynomial_add_sub_generator.py |
| `PRIME` | 1 | `PRIME\|23` | divisibility_classification_generator.py |
| `PROB_CONDITIONAL` | 2 | `PROB_CONDITIONAL\|P(red\|first was red)\|6/13` | compound_probability_generator.py |
| `PROB_DEPENDENT` | 1 | `PROB_DEPENDENT\|Drawing without replacement means dependent events` | compound_probability_generator.py |
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Draw with replacement: red then blue` | compound_probability_generator.py |
| `PROB_IDENTIFY` | 2 | `PROB_IDENTIFY\|P(red)\|1/13` | compound_probability_generator.py |
| `PROB_INDEPENDENT` | 1 | `PROB_INDEPENDENT\|Drawing with replacement means independent events` | compound_probability_generator.py |
| `PROB_MULTIPLY` | 3 | `PROB_MULTIPLY\|1/13\|6/13\|6/169` | compound_probability_generator.py |
...
| `PYTHAG_SETUP` | 3 | `PYTHAG_SETUP\|c=26\|a=10\|b=?` | pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 676 - 100\|576` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|10\|100` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|10² + b² = 26²` | pythag_leg_generator.py |
| `Q1` | 4 | `Q1\|27\|9\|6\|6` | quadratic_generator.py |
| `Q2` | 4 | `Q2\|27\|9\|6\|3` | quadratic_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 90 / 0.1` | percent_problem_generator.py |
...
| `ROOT` | 2 | `ROOT\|26896\|164` | pythag_hyp_generator.py, quadratic_generator.py |
| `ROOT_EXTRACT` | 2 | `ROOT_EXTRACT\|6` | exponent_generator.py |
| `ROOT_IDENTIFY` | 3 | `ROOT_IDENTIFY\|36\|perfect_square\|6` | exponent_generator.py |
| `ROOT_SETUP` | 1 | `ROOT_SETUP\|√36` | exponent_generator.py |
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|4√7` | exponent_generator.py |
...
| `SA_BASES` | 2 | `SA_BASES\|2π(5)² = 2π × 25\|50π` | volume_3d_generator.py |
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|4 × 7\|28` | volume_3d_generator.py |
| `SA_FORMULA` | 1 | `SA_FORMULA\|SA = 2(lw + lh + wh)` | volume_3d_generator.py |
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 5 × 10\|100π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=4, w=7, h=6` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(28 + 24 + 42)\|188` | volume_3d_generator.py |
...
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|8.9\|5` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|right\|5` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|multiply_coefficients\|2.8\|2.6\|7.279999999999999` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|(2.8 × 10^6) × (2.6 × 10^2)` | exponent_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -2x + 10` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-1` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(1, -5)\|(9, -5)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-5 - (-5)) / (9 - 1)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(49 + 60) / 2\|54.5` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|9` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|21\|27\|-6` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|513 / 9\|57` | statistics_generator.py |
| `STAT_FREQUENCY` | 2 | `STAT_FREQUENCY\|12\|2` | statistics_generator.py |
| `STAT_MAD` | 3 | `STAT_MAD\|34\|5\|6.8` | statistics_generator.py |
| `STAT_MAX` | 1 | `STAT_MAX\|93` | statistics_generator.py |
| `STAT_MEAN` | 2 | `STAT_MEAN\|135 / 5\|27` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|positions 3 and 4\|49, 60` | statistics_generator.py |
| `STAT_MIN` | 1 | `STAT_MIN\|18` | statistics_generator.py |
| `STAT_MODE` | 2 | `STAT_MODE\|58\|4` | statistics_generator.py |
| `STAT_ORDER` | 1 | `STAT_ORDER\|14, 40, 49, 60, 75, 87` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|93 - 18\|75` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|52, 47, 37, 48, 80, 38, 66, 82, 63` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|52 + 47 + 37 + 48 + 80 + 38 + 66 + 82 + 63\|513` | statistics_generator.py |
...
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -3y = -12` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with y only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = 4y + 0` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * -1` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|5x - 5y = -45\|-5x + 2y = 33` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x - 4y = 0\|0x + 3y = 0` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=0 into x = 4y + 0` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|1x + 16\|4x + 3\|3x + 81` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|8x + 100 = 180\|x = 10` | angle_relationships_generator.py |
| `TRI_ANGLE_SUM` | 1 | `TRI_ANGLE_SUM\|(1x + 16) + (4x + 3) + (3x + 81) = 180` | angle_relationships_generator.py |
...
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 6 × 6\|18.0` | volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 18.0 × 10\|180.0` | volume_3d_generator.py |
| `VOL_FORMULA` | 1 | `VOL_FORMULA\|V = Base Area × length` | volume_3d_generator.py |
| `VOL_SETUP` | 2 | `VOL_SETUP\|triangular_prism\|b=6, h_tri=6, length=10` | volume_3d_generator.py |
