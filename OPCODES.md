...
353 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|- 2x^3 + 5x^2 - 5x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|46281 × 43767 ≈ 50000 × 40000\|2000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2000000000\|2025580527\|2025580527 ≈ 2000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|11 × 8 = 88, not 72` | error_spotting_generator.py |
...
| `MID_FORMULA` | 1 | `MID_FORMULA\|M = ((x1 + x2)/2, (y1 + y2)/2)` | midpoint_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 18% to 0.18\|line 3 adds the tip 23.04 to the bill` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(484, 9)\|P(X < 474.1)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(21x^6 - 35x^5 + 28x^2) / (7x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(21x^6) / (7x^2) + (-35x^5) / (7x^2) + (28x^2) / (7x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 4)(-2x^2 + 5x - 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(474.1 - 484)/9\|-1.10` | normal_table_generator.py |
