...
1074 distinct op-codes observed.
...
| `COUNT` | 2 | `COUNT\|A = [4, 5, 6]\|3/6` | mle_generator.py, probability_addition_rule_generator.py, set_operations_generator.py |
...
| `SUM` | 2, 3 | `SUM\|29 + 31 + 37 + 33 + 35\|165` | mle_generator.py, regression_generator.py |
