...
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(6, 4)\|n!/(r!·(n-r)!)` | permutation_combination_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-x\|- 5x^3 - 4x^2 + 3x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|83610 × 53335 ≈ 80000 × 50000\|4000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|4000000000\|4459339350\|4459339350 ≈ 4000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-12 ÷ 2 = -6, not -8` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 6, giving -36\|line 4 divides by 4` | fill_in_step_generator.py |
...
| `PERM_SETUP` | 2 | `PERM_SETUP\|arrange 3 of 5\|order matters` | permutation_combination_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 12x^5 - 8x^3 + 12x^2) / (4x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-12x^5) / (4x) + (-8x^3) / (4x) + (12x^2) / (4x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x + 1)(5x^2 + 4x - 3)` | multiplying_polynomials_generator.py |
