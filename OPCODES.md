...
328 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|- 15x^3 + 6x^2 + 9x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | complex_division_generator.py, exponential_model_generator.py, factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_sequence_generator.py, log_conversion_generator.py, piecewise_evaluation_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|93658 × 81799 ≈ 90000 × 80000\|7200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|7200000000\|7661130742\|7661130742 ≈ 7200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | complex_division_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, log_conversion_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|11 × 7 = 77, not 70` | error_spotting_generator.py |
...
| `LOG_IDENT` | 2 | `LOG_IDENT\|e^(ln x) = x (inverse functions)\|5` | log_conversion_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(25, 4)\|P(26.6 < X < 33)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(10x^5 + 4x^4 - 2x^3 - 4x) / (-2x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(10x^5) / (-2x) + (4x^4) / (-2x) + (-2x^3) / (-2x) + (-4x) / (-2x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x - 3)(-5x^2 + 2x + 3)` | multiplying_polynomials_generator.py |
...
| `REWRITE` | 1 | `REWRITE\|8 + 90` | completing_square_generator.py, complex_division_generator.py, complex_number_ops_generator.py, domain_range_generator.py, evaluate_expression_generator.py, exponent_mixed_rules_generator.py, factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, inverse_function_generator.py, linear_complex_generator.py, linear_fractional_generator.py, literal_equation_generator.py, log_conversion_generator.py, normal_table_generator.py, order_of_operations_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_add_sub_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py, rational_equation_generator.py, rational_exponent_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, rational_function_features_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py, synthetic_division_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(26.6 - 25)/4\|0.40` | normal_table_generator.py |
