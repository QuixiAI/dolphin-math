...
ALL_GENERATORS = [
    ...
    # Mixed numbers: include a random picker plus explicit variants if filtering
    ...
    # Middle School (6-8) - Statistics & Probability
    MeanGenerator(),
    MedianGenerator(),
    ModeGenerator(),
    RangeGenerator(),
